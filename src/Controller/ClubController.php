...
class ClubController extends AbstractController
{
    ...
    public function formations()
    {
        ...
        $formations = array(
            ...
            'Description'=>'theorique','date_debut'=>'10/06/2020','date_fin'=>'14/06/2020','nb_participants'=>12));

        return $this->render('club/list.html.twig',array("XYZ"=>$var1,"salle"=>$var2,"tab"=>$formations));
    }
